...
description: >
  ...
  Use this skill:
    * When developing Spring Boot applications using Spring MVC, Spring Data JPA, Spring Data JDBC, Spring Modulith, Spring Security
...
When the module uses Spring Data JDBC instead of JPA (e.g. `data-jdbc`,
`rest-mvc`, `web-app-demo`, `retry`), implement the aggregate-root and
repository layer using [references/spring-data-jdbc.md](references/spring-data-jdbc.md).
