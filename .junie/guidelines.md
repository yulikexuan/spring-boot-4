...
This document outlines the coding standards and best practices for Junie when working on this project, which is built on **Spring Boot 4.0.2** and **Java 25**.
...
## Spring Boot 4.0.2 & Java 25 Guidelines
